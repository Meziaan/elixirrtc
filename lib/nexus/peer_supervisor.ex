defmodule Nexus.PeerSupervisor do
  ...
  @spec add_peer(String.t(), String.t(), String.t(), pid(), [String.t()], Nexus.Data.Participant.t()) ::
          {:ok, pid()}
  def add_peer(room_id, room_name, id, channel_pid, peer_ids, participant) do
    peer_opts = [room_id, room_name, id, channel_pid, peer_ids, participant]
